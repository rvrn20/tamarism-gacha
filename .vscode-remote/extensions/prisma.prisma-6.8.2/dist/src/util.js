...
function checkForOtherPrismaExtension() {
    ...
    if (files.length !== 0) {
        ...
        vscode_1.window.showInformationMessage(`You have both versions (Insider and Stable) of the Prisma VS Code extension enabled in your workspace. Please uninstall or disable one of them for a better experience.`);
